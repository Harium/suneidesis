...
public class Action extends Concept {
    ...
    public Action subject(Concept subject) {
        getAttributes().insert(ATTRIBUTE_SUBJECT, subject);
        return this;
    }
    ...
    public Action predicate(Concept predicate) {
        getAttributes().insert(ATTRIBUTE_PREDICATE, predicate);
        return this;
    }
    ...
    public Action object(Concept object) {
        getAttributes().insert(ATTRIBUTE_OBJECT, object);
        return this;
    }
    ...
    public Action objectPart(Concept objectPart) {
        getAttributes().insert(ATTRIBUTE_OBJECT_PART, objectPart);
        return this;
    }
    ...
    public Action place(Place place) {
        getAttributes().insert(ATTRIBUTE_PLACE, place);
        return this;
    }
    ...
    public Action time(Time time) {
        getAttributes().insert(ATTRIBUTE_TIME, time);
        return this;
    }
    ...
    public Action phenomenon(Phenomenon phenomenon) {
        getAttributes().insert(ATTRIBUTE_PHENOMENON, phenomenon);
        return this;
    }
